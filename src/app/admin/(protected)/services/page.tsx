...
import { deleteService, toggleServicePublished } from "@/features/admin/services/actions";
...
export default async function ServicesAdminPage() {
  ...
  return (
    <>
      <PageHeader
        title="Leistungen"
        subtitle="Dienstleistungen verwalten (DE/EN/RU)."
              ...
              return (
                <tr key={r.id} className="border-b border-line last:border-0">
                  ...
                  <td className="px-4 py-3">
                    <form action={toggleServicePublished.bind(null, r.id, !r.published)}>
                      <button
                        className={
                          r.published
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-end gap-2">
                      <Link href={`/admin/services/${r.id}`} className={adminBtnGhost}>
                        Bearbeiten
                      </Link>
                      <form action={deleteService.bind(null, r.id)}>
                        <ConfirmButton
                          message="Diese Leistung wirklich löschen?"
