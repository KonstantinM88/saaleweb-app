...
export function Dashboard() {
  ...
  return (
    <div ref={ref} className="relative">
      <div className="absolute -right-4 -top-5 z-10 flex animate-bob items-center gap-2.5 rounded-xl border border-line bg-white px-3.5 py-2.5 text-[13px] font-semibold shadow-card">
        <span className="grid h-7 w-7 place-items-center rounded-lg bg-brand text-white">↑</span>
        {tf("a")}
      </div>
      <div className="absolute -bottom-5 -left-5 z-10 flex animate-bob items-center gap-2.5 rounded-xl border border-line bg-white px-3.5 py-2.5 text-[13px] font-semibold shadow-card [animation-delay:0.4s]">
        <span className="grid h-7 w-7 place-items-center rounded-lg bg-brand text-white">★</span>
        {tf("b")}
      </div>
