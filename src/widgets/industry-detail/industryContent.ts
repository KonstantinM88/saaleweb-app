  ...
  hotels: {
    de: {
      ...
      features: [
        ...
        { title: "Mehrsprachig", desc: "DE/EN/RU für Gäste aus dem In- und Ausland." },
      ],
    ...
    en: {
      ...
      features: [
        ...
        { title: "Multilingual", desc: "DE/EN/RU for guests from home and abroad." },
      ],
    ...
    ru: {
      ...
      features: [
        ...
        { title: "Мультиязычность", desc: "DE/EN/RU для гостей из страны и из-за рубежа." },
      ],
